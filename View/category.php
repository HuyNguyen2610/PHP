			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<div class="filter-bar d-flex flex-wrap align-items-center">
					...
					<div class="pagination">
						...
						<a href="index.php?action=category&page=<?php echo ($current_page - 1) ?><?php echo $url ?>" class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
						
						<?php
						}
                        for($i=1;$i<=$page;$i++){
                    	?>
						<a href="index.php?action=category&page=<?php echo $i ?><?php echo $url ?>"><?php echo $i ?></a>
						<?php } ?>

						<?php 
						if ($current_page < $page && $page > 1) {
						?>
						<a href="index.php?action=category&page=<?php echo ($current_page + 1) ?><?php echo $url ?>" class="next-arrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
						<?php } ?>
					</div>
				</div>
				<!-- End Filter Bar -->
