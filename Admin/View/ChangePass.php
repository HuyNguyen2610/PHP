    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?action=Auth&act=changepass_action&id=<?php echo $id ?>">
                        <div class="form-floating mb-3">
                            <input class="form-control " id="inputEmail" type="text" placeholder="Password" value="<?php echo $makh ?>"
                                name="makh" hidden />
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control " id="inputEmail" type="text" placeholder="Password" value="<?php echo $email ?>"
                                name="email" readonly />
